...
Source/NTC/%.o Source/NTC/%.su Source/NTC/%.cyclo: ../Source/NTC/%.c Source/NTC/subdir.mk
...
clean: clean-Source-2f-NTC

clean-Source-2f-NTC:
	-$(RM) ./Source/NTC/ntc.cyclo ./Source/NTC/ntc.d ./Source/NTC/ntc.o ./Source/NTC/ntc.su

.PHONY: clean-Source-2f-NTC
